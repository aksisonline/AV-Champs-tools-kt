...
export default function ToolPage() {
  ...
  if (error || !tool) {
    return (
      <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8 ml-60">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Tool Error</h2>
            <p className="text-gray-500 mb-6">{error || "Tool not found"}</p>
