 ...
 */
export function generatePDF(title: string, content: PDFContentItem[], filename = "avchamps-result.pdf"): void {
  ...
  doc.setProperties({
    title: title,
    subject: "AV Champs Tool Result",
    author: "AV Champs",
    creator: "AV Champs Tool",
  })
...
function addHeader(doc: jsPDF, title: string): void {
  ...
  doc.setFillColor(37, 99, 235) // AV Blue
...
function addFooter(doc: jsPDF, currentPage: number, totalPages: number): void {
  ...
  doc.text("www.avchamps.com", 90, 285)
}
