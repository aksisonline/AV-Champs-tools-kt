...
export default function ChatBot() {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: "bot",
      content: "👋 Hi there! I'm AV Assistant. How can I help you today?",
      timestamp: new Date(),
    },
  ])
  ...
  const getBotResponse = (message: string) => {
    ...
    if (lowerMsg.includes("hello") || lowerMsg.includes("hi") || lowerMsg.includes("hey")) {
      return "Hello there! How can I assist you with AV Champs today?"
    } else if (lowerMsg.includes("service") || lowerMsg.includes("offer")) {
      return "We offer a variety of services including AV Tools, Community Forums, Marketplace (Kart), Professional Reviews, and Training Programs. Which one would you like to know more about?"
    } else if (lowerMsg.includes("tool")) {
      return "Our tools include VC Bar Simulator, Room Design Tools, Equipment Calculators, and more. These tools help AV professionals design and implement better systems. Would you like to explore our tools section?"
    } else if (lowerMsg.includes("join") || lowerMsg.includes("community") || lowerMsg.includes("sign up")) {
      return "Joining our community is easy! Click the 'Sign Up' button in the top navigation bar and follow the registration process. You'll get access to forums, resources, and networking opportunities with other AV professionals."
    } else if (lowerMsg.includes("contact") || lowerMsg.includes("support") || lowerMsg.includes("help")) {
      return "You can reach our support team at hello@avchamps.com or call us at +91 9966416417. Alternatively, you can fill out the contact form on our Contact page."
          ...
          >
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <Button
                  size="sm"
                  className="mt-2 w-full bg-avblue-600 hover:bg-avblue-700 text-white"
                  onClick={() => {
                    setShowTooltip(false)
                    setIsOpen(true)
                  }}
        ...
        {!isOpen && (
          ...
          >
            <div className="relative w-full h-full">
              <Image src="/chatbot-icon.png" alt="AV Assistant" fill className="object-fill" sizes="56px" priority />
            </div>
          </motion.button>
        )}
      </AnimatePresence>
          ...
          >
            ...
            <div className="p-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-medium text-sm">AV Assistant</h3>
            ...
            <div className="p-4 border-t border-gray-200 bg-white">
              <div className="flex space-x-2">
                ...
                <Button
                  ...
                  className="rounded-full bg-avblue-600 hover:bg-avblue-700 text-white"
