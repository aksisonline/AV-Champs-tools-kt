...
export default function FeedbackPopup({ toolId, toolName, onClose }: FeedbackPopupProps) {
  const hasFeedbackBeenSubmitted = (toolId: string): boolean => {
    ...
    const submittedFeedback = localStorage.getItem("av-tools-feedback-submitted")
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!submittedTools.includes(toolId)) {
        ...
        localStorage.setItem("av-tools-feedback-submitted", JSON.stringify(submittedTools))
      }
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-3 mt-4">
                ...
                <Button
                  ...
                  className="bg-avblue-600 hover:bg-avblue-700 text-white"
                >
